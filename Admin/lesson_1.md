...
### Создание новой роли
Создать новую роль от лица супер пользователя:
...
3) Подключение к уже существующей БД `psql -d <DataBase> -U <user>`
...
```   
  psql --host=127.0.0.1 --port 5432 --username postgres --dbname work_ngw_test --file backup_ngw.sql
```
